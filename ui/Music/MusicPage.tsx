  ...
  return (
    ...
    <div className='mt-8'>
      <h1 className="font-bold text-lg">
        Singles</h1>
        <div className="flex md:grid md:grid-cols-3 md:justify-items-center items-center gap-8 overflow-x-auto space-y-2">
        {music.map((item: any) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-md md:max-w-7xl md:p-4  md:items-center"></div>
  </div>
  )
}
